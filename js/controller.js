  ...
  // play music on interaction or when site is loaded on mobile
  function playMusic() {
      if (!musicStarted) {
          Music.play();
          musicStarted = true;
  ...
  // save name and send it to the server
  ...
  // handle button presses and send the corresponding message to the server
